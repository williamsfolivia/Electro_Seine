...
library(ggpubr)
library(rstatix)
Raw_Rouge<-read_csv("~/Desktop/Paper Code/Delisting_FOTR/Delisting_FOTR/Data/Created_Data/Close_date_rouge.csv", 
    col_types = cols(...1 = col_skip(), DateSampled = col_date(format = "%Y-%m-%d"), 
        TotalFish = col_number()))

Final_score2023 <- read_csv("~/Desktop/Paper Code/Delisting_FOTR/Delisting_FOTR/Data/Created_Data/Final_scores_2023.csv", 
    col_types = cols(...1 = col_skip()))

Newnames<- read_csv("~/Desktop/Paper Code/Delisting_FOTR/Delisting_FOTR/Data/Created_Data/VisualNames.csv")
...
```{r}
Final_join<-rbind(Total_scores,Considerations_subset)
